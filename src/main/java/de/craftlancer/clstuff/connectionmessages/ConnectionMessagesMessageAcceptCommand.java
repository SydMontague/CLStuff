...
public class ConnectionMessagesMessageAcceptCommand extends SubCommand {
    
    private ConnectionMessages connectionMessages;
    
    public ConnectionMessagesMessageAcceptCommand(Plugin plugin, ConnectionMessages connectionMessages) {
    ...
    protected String execute(CommandSender sender, Command command, String s, String[] args) {
        ...
        connectionMessages.acceptPending(optional.get());
        
        return connectionMessages.getPrefix() + " §aMessages accepted.";
    }
