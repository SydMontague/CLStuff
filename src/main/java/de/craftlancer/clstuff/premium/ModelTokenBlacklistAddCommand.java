...
public class ModelTokenBlacklistAddCommand extends ModelTokenSubCommand {
    
    public ModelTokenBlacklistAddCommand(Plugin plugin, ModelToken token) {
    ...
    protected String execute(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (getToken().addBlacklist(mat, cmdList))
